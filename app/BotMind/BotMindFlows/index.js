...
const questions = {
  start: {
    botPrompt: 'Hello , I am <strong>Kranti</strong>!',
    answers: [
      {
        nextId: 'myPurpose',
      },
  ...
  myPurpose: {
    botPrompt: 'My purpose is to spread KRANTI in our Country',
    answers: [
      {
        nextId: 'msg',
      },
  ...
  msg: {
    botPrompt: 'Please join our whatsapp grou for daily updates',
    answers: [
      {
        nextId: 'check_out2',
      },
  ...
  check_out2: {
    botPrompt: 'https://chat.whatsapp.com/ITE5EsK1glRHmidhPGbNz8',
    type: RTypes.LINK,
